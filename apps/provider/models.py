...
from .utils import get_practitioner


@python_2_unicode_compatible
class Address(models.Model):
    npi                     = models.CharField(max_length=10, default="", blank=True)
...
class Practitioner(models.Model):
    ...
    npi                     = models.CharField(max_length=10, default="", unique=True,
                                              )
